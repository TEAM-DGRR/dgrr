...
export const GameResult = () => {
	...
	const { firstRoundTime, secondRoundTime, gameResult, reward, afterRank } = myGameResult;
	...
	let nextRating = newRating >= 1400 && newRating < 1600 ? 1600 : newRating < 1800 ? 1800 : 0; //다음 등급 Rating
				...
				<div className='battle-bottom'>
					<div className='battle-result'>
						<div className='result-left'>
							...
							<img className='profile-image' src={enemyInfo.profileImage} alt='프로필 이미지' />
